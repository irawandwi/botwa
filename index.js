...
/////////////////
const BotName = 'AnjimBot'; 
const instagram = 'https://instagram.com/wawan_artan37'; 
const telegram = 'https://t.me/WawanArtan'; 
const kapanbotaktif = 'JIKA OWNER PENGEN'; 
const youtube = 'https://bit.ly/30i8WXH';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:wawan_artan37`)
})
